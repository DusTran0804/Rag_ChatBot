...
4. Nếu câu hỏi của người dùng chỉ là một từ khóa hoặc cụm từ ngắn, hãy coi đó là yêu cầu giải thích, định nghĩa hoặc cung cấp thông tin liên quan về từ khóa đó dựa trên Ngữ cảnh.
5. Không tự suy diễn, không tự bịa đặt thêm thông tin đối với các truy vấn tìm kiếm."""
